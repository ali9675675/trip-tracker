# Generated by Django 5.1.1 on 2024-09-05 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='nodes')),
                ('rating', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MaxValueValidator(5)])),
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nodes', to='trip.trip')),
            ],
        ),
    ]
